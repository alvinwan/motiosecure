...
electron-packager . "MotioSecure" --app-bundle-id=com.alvinwan.mac.MotioSecure --app-version=0.1 --build-version=0.1 --platform=mas --arch=x64 --electron-version=0.36.7 --icon=Icon.icns --overwrite
